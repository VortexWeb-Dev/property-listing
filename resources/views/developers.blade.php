                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            <span class="inline-block size-[38px] bg-gray-200 flex items-center justify-center rounded-full">A</span>
                                            <div class="grow">
                                                <span class="block text-sm font-semibold text-gray-800">ABC Developer</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <span class="block text-sm font-semibold text-gray-800"><a href="#" class="text-blue-600 hover:underline">example.com</a></span>
                                    </div>
                                </td>
