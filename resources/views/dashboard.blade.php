<x-layout>
    <!-- <div class="absolute bottom-4 right-4 rounded-full" title="Create Listing">
        <a href="/create-listing"
            class="inline-flex items-center px-4 py-4 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr class="bg-white hover:bg-gray-50">
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <div class="hs-dropdown [--placement:bottom-left] relative inline-block">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <a class="block relative z-10" href="#">
                                            <div class="px-6 py-2">
                                                <div class="block text-sm text-blue-600 decoration-2 hover:underline">DUMMY-PROPERTY-125</div>
                                            </div>
                                        </a>
                                    </td>
                                    <td class="h-px w-72 min-w-72">
                                        <div class="block relative z-10">
                                            <div class="px-6 py-2">
                                                <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus architecto doloribus mollitia animi adipisci eius corrupti...</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="block relative z-10">
                                            <div class="px-6 py-2 flex flex-col gap-y-1">
                                                <span class="inline-flex items-center gap-1.5 py-1 px-2 rounded-lg text-xs font-medium bg-gray-100 text-gray-800">
                                                    VH
                                                </span>
                                                <span class="inline-flex items-center gap-1.5 py-1 px-2 rounded-lg text-xs font-medium bg-gray-100 text-gray-800">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="block relative z-10">
                                            <div class="px-6 py-2 flex -space-x-2">
                                                <p class="text-sm text-gray-500">AED 1,35,400</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="block relative z-10">
                                            <div class="px-6 py-2 flex -space-x-2">
                                                <p>City</p> <p>Community</p> <p>Sub Community</p> <p>Building</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                ...
                                                <div class="grow">
                                                    <span class="block text-sm font-semibold ">Christina Bersh</span>
